...
public class CustomerController {
    ...
    public String welcome() {
        ...
        return "Welcome to this small REST service. TESTTESTTEST. It will accept a GET on /list with a request parameter lastName, and a POST to / with a JSON payload with firstName and lastName as values.";
    }
